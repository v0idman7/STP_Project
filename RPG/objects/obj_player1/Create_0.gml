...
weapon_sword = false; //есть ли меч
weapon_bow = false; //есть ли лук

weapon_ind = 1; //тип оружия
attack1 = 29; //кол-во кадров необходимое для удара мечом
attack2 = 64; //кол-во кадров необходимое для использования лука
