...
var xx = x - x_offset;
var yy = y - y_offset;
if (attack1 = 29){ //если не выполняется аттака
	anim_length = 9;
...
attack1 = 0}}//выбираем первый кадр удара мечём
